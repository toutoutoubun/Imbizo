...
This bibliography is consolidated from the MVP documentation and the v1.0 increment. The release-specific roadmap delta is in [docs/v1_0/ROADMAP_AND_REFERENCES.md](v1_0/ROADMAP_AND_REFERENCES.md).
